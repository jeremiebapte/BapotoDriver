...
import com.bapoto.bapotodriver.databinding.ActivityDriversBinding;
...
public class DriversActivity extends BaseActivity implements UserListener {

    private ActivityDriversBinding binding;
    private PreferenceManager preferenceManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityDriversBinding.inflate(getLayoutInflater());
...
// TODO ADMINS ACTIVITY pour afficher les admins disponibles